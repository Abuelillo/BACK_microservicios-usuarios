package com.micro.usuarios.controllers;
...
import com.micro.usuarios.services.AlumnoService;
...
public class Alumnocontroller extends CommonController<Alumno, AlumnoService> {
	...
	public ResponseEntity<?> verFoto(@PathVariable Long id){
		...
		if (a.isEmpty() || a.get().getFoto()== null) {
			return ResponseEntity.notFound().build();
		}
		
		Resource imagen = new ByteArrayResource(a.get().getFoto());
